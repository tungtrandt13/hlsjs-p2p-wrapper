...
It also provides a **wrapper** that allows you to create/configure a player with a specific version of [`Hls.js`](https://github.com/dailymotion/hls.js). **Minimum supported version of hls.js is vPUT_VERISON_HERE**.
