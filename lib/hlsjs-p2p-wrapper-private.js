...
class HlsjsP2PWrapperPrivate {
    ...
    createPeerAgent(p2pConfig, hlsjs, hlsEventsEnum, url = null) {
        ...
        this.mediaMap = new MediaMap(hlsjs);

        this.peerAgentModule = new StreamrootPeerAgentModule(playerBridge, contentUrl, this.mediaMap, p2pConfig, SegmentView, streamType, integrationVersion);
