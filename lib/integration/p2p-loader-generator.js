    ...
    return class P2PLoader {
        ...
        constructor(config) {
            if (config) {
                ...
                // initialize with basic header config. we might extend this as we evaluate xhrSetup
        ...
        loadInternal() {
            ...
            let {headers, withCredentials} = extractInfoFromXhrSetup(this.xhrSetup, this.url, this.headers);
