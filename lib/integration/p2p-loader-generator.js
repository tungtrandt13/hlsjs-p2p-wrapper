...
const P2PLoaderGenerator = function (hlsjsWrapper) {
    ...
    return class P2PLoader {
        ...
        load(url, context, responseType, onSuccess, onError, onTimeout, timeout, maxRetry, retryDelay, onProgress, frag) {
            if (!onProgress) {
        ...
        loadSuccess(segmentData) {
            ...
            this.onSuccess(event, this.stats, this.context);
            this.reset();
        }
        ...
        loadError (xhrEvent) {
            ...
            if (this.stats.retry < this.maxRetry) {
                ...
                this.onError(xhrEvent, this.context);
                this.reset();
            }
        }
        ...
        loadProgress(event) {
            ...
            this.onProgress(event, this.stats, this.context);
        }
